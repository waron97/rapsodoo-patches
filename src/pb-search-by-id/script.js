(function () {
    ...
    function openModalWithInput(processes) {
        return new Promise((resolve, reject) => {
            ...
            modalContainer.className = 'pb-finder-modal-container';

            // Create the modal content
            const modalContent = document.createElement('form');
            modalContent.className = 'pb-finder-modal-content';
            ...
            inputField.className = 'pb-finder-modal-input';
            ...
            button.className = 'pb-finder-modal-button';
            modalContent.appendChild(button);

            // create suggestions area
            const suggestionsArea = document.createElement('div');
            suggestionsArea.className = 'pb-finder-suggestions-area';
            suggestionsArea.tabIndex = -1; // Make the area itself not focusable
            ...
            inputField.addEventListener('input', (evt) => {
                ...
                processesToShow.forEach((process) => {
                    ...
                    suggestionBtn.className = 'pb-finder-suggestion-btn';
                    ...
                    if (process.document_id) {
                        ...
                        idElement.className = 'pb-finder-suggestion-id';
                    ...
                    if (process.process_name) {
                        ...
                        nameElement.className = 'pb-finder-suggestion-name';
                ...
                if (processesToShow.length === 0) {
                    ...
                    noMatchesMsg.className = 'pb-finder-no-matches';
                ...
                if (matchingProcesses.length > maxSuggestions) {
                    ...
                    countMsg.className = 'pb-finder-count-msg';
